...
class EventController extends ControllerBase{
 ...
 public function editAction(){
    if($this->request->isPost()){
      $name = trim($this->request->getPost('event_name')); // รับค่าจาก form
      $date = trim($this->request->getPost('event_')); // รับค่าจาก form
      $detail = trim($this->request->getPost('event_detail')); // รับค่าจาก form
      $picture = trim($this->request->getPost('event_picture')); 
